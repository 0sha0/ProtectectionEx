...
#if _WIN64
//64Î»LDR_DATA_TABLE_ENTRY½á¹¹Ìå,ÓÃÓÚÈÆ¹ýMmVerifyCallbackFunctionº¯Êý
...
EXTERN_C NTSTATUS PsLookupThreadByThreadId(HANDLE Id, PETHREAD* Thread);
EXTERN_C PEPROCESS IoThreadToProcess(PETHREAD Thread);
